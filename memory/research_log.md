...
Macro: VIX 16.70 (low), Russell 2000 +0.91% Fri, S&P 500 +0.37% Fri. Risk-on backdrop intact.
Friday's both-lists overlap: **HYLN, SPCE, HLIT, CRNC, DXYZ, LPTH, FLO**.
Reset day — most Fri pops will need to prove themselves again Tuesday after a 3-day gap.

---

## 1. HLIT — Harmonic Q1 Blowout + Video Unit Sale Closing Q2 (NEW HIGH)
- Catalyst: Q1 2026 EPS $0.17 (vs guide $0.11-$0.12), broadband revenue +43% YoY, raised full-year outlook, broadband backlog/deferred record $582.1M (+87% YoY, 60% to convert in 12mo). Video business sale "progressing as planned" expected to close Q2. Cascade of analyst upgrades. CableLabs chip verification adds technology validation.
- Market cap: $1.65B (top of small-cap range) | Price: $15.20 (Fri close) | Day: +19.7% | NASDAQ
- Float: Mid (mature company, S&P SmallCap 600 territory)
- Entry plan: 3-day gap = needs re-confirmation. Wait 10-min base post-open. Enter on hold above $15.40 with volume >1.5x avg. Skip if opens >$16.00 (chase). Pullback to $14.50 with absorption = alternative entry.
- Stop: $14.14 (7% below $15.20)
- Target: 1st 1/3 at $17.48 (+15%), 2nd at $19.00 (+25%), trail final 1/3
- Conviction: **HIGH** — clean fundamental beat + raised guidance + active M&A optionality + analyst momentum = textbook small-cap catalyst stack
- Risk: $1.65B mcap = near ceiling of universe, less explosive upside. Move already +19.7% Fri = some chase risk. Video sale delays could disappoint.

---

## 2. DXYZ — SpaceX IPO Continuation (Day 4)
- Catalyst: SpaceX S-1 filed Wed 5/20 for Nasdaq IPO (SPCX), ~$75B raise, ~$2T valuation. DXYZ is the primary public-traded SpaceX-exposure proxy (~14.5-16.2% of fund). Multi-day continuation — closed Fri at $66.64.
- Market cap: $961M | Price: $66.64 | Day Fri: +8.1% | NYSE closed-end fund
- Float: Small (closed-end fund structure)
- Entry plan: Watch for gap on Tuesday open. If gap >5%, fade — wait 30 min. Clean entry: hold above $67 with volume on 10-min reclaim, OR pullback to $63-64 zone. Premium-to-NAV risk is real here.
- Stop: $61.97 (7% below $66.64)
- Target: 1st 1/3 at $76.64 (+15%), 2nd at $83.30 (+25%), trail final 1/3
- Conviction: **MEDIUM-HIGH** — narrative will run multi-week, but stock has rallied 4 sessions. Pullback entry preferred over chase.
- Risk: NAV premium blowout, SpaceX IPO pricing/timing surprises, profit-taking after holiday 3-day gap.
...
- Stop: $15.76 (7% below $16.95)
- Target: 1st 1/3 at $19.49 (+15%), 2nd at $21.19 (+25%), trail final 1/3
- Conviction: **MEDIUM-HIGH** — fundamental breakout backed by real backlog data + defense IR theme
- Risk: Earnings catalyst now ~3 weeks old, move is mostly technical/retail at this point. Margins still negative. Volume on Fri was only modest.
...
- Stop: $10.21 (7% below $10.98)
- Target: 1st 1/3 at $12.63 (+15%), 2nd at $13.73 (+25%), trail final 1/3
- Conviction: **MEDIUM** — multi-factor catalyst (litigation + earnings + guide-up + chart break), but EPS miss + Goldman PT only $9 = mixed reception
- Risk: Litigation outcomes unpredictable, EPS miss could weigh, automotive AI/voice secular questions remain. Sub-$500M mcap = volatile.

---

## 5. ASCO Run-Up Watchlist — Conference May 29 – June 2 (Biotech Setup)
- Catalyst: ASCO Annual Meeting starts Fri 5/29. Historical pattern: small-cap oncology biotechs run into ASCO presentations on hype, then fade post-data.
- Named to monitor: **MBRX** (Annamycin pooled cardiac safety poster), **ONCY** (pelareorep mechanism data from GOBLET/AWARE-1)
- Entry plan: NOT placing trades yet. Will scan Tue AM for low-float oncology names with ASCO presentations + unusual volume building.
- Conviction: **WATCH ONLY** — only act if specific name shows 1) confirmed ASCO presentation, 2) low float <30M, 3) unusual volume >2x, 4) chart structure
- Risk: ASCO post-data fade pattern is well-known; this trade requires getting in before the presentation, not on it. Always exit before data or size very small.

---

## Watch-Only / Skip List

- **HYLN** ($5.99, +42.6% Fri): Parabolic 3-day move. Friday note already flagged chase risk; Fri tape confirmed. SKIP unless deep pullback to $5.00 zone with absorption.
- **SPCE** ($3.24, +17.8%): At $3 floor (universe minimum). No fresh catalyst — sector sympathy only. SKIP.
- **SHAZ** ($68.06, +17.9%): $350M convertible note closed 5/20 = dilution overhang; AI cloud deal real but mcap $1.09B at top of range. Mixed signals. SKIP.
- **BKSY** ($47.87, +7.2%): Established $250M ATM equity program 5/22 — active dilution overhang. **SKIP** per lessons (avoid dilution announcements).
- **FLO** ($7.94, +13.3%): $1.68B Consumer Defensive earnings beat. At mcap ceiling, low momentum sector. SKIP.
- **IMMX** ($8.78, +1.3% Fri): Phase 2 CAR-T 95% CR data hasn't moved stock — Fri thesis broken at 9:35 confirmed by EOD close near flat. SKIP unless volume spike + MA20 reclaim ($9.45+).
- **CPSH** ($6.00, +28.5%): $108M tiny mcap, only $7M Q1 revenue. Move looks like retail-driven. No verifiable major catalyst. LOW PRIORITY.
- **SPIR** ($21.16, +10.2%): Q1 was 5/13 (~2 weeks stale). $851M mcap. Late entry. WATCH only.
- **KULR** ($4.61): Below high-conviction threshold, mixed CFO signal. LOW PRIORITY.
- **WW** ($12.79, +26.8%): No catalyst — squeeze bounce off ATL. SKIP.

---

## Execution Notes — 2026-05-26 Tuesday Open (post-holiday)

- Cash available: $100,000 (Rocket dedicated account)
- Open positions: 0 / 4 max | Trades this week: 0 / 5 max
- Max position: $15,000 (15% cap), risk-based sizing per 1.5% rule = ~$1,500 risk/trade
- **Top 2 for 9:35 Tue**: **HLIT** (post-earnings continuation) + **DXYZ** (SpaceX IPO continuation)
...
*(Trade outcomes logged here after closing)*
